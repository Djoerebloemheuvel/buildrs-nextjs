    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(59, 130, 246, 0.25) 0%, rgba(37, 99, 235, 0.18) 35%, rgba(29, 78, 216, 0.08) 60%, transparent 85%)',
            filter: 'blur(100px)',
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(147, 51, 234, 0.22) 0%, rgba(139, 92, 246, 0.15) 40%, rgba(124, 58, 237, 0.06) 70%, transparent 90%)',
            filter: 'blur(90px)',
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(59, 130, 246, 0.18) 0%, rgba(147, 51, 234, 0.12) 50%, rgba(124, 58, 237, 0.04) 80%, transparent 95%)',
            filter: 'blur(80px)',
      ...
      <div className="relative max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="relative rounded-[24px] p-12 md:p-16 backdrop-blur-xl border border-white/[0.15] shadow-2xl"
          ...
          <div className="absolute inset-0 rounded-[24px] bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-blue-500/10 blur-lg opacity-40 -z-10" />
          
          {/* Content */}
          <div className="relative z-10 space-y-8">
            {/* Premium headline with enhanced gradient */}
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight">
              <span className="text-white">Zet je eerste </span>
            ...
            <p className="text-lg md:text-xl text-premium-silver/90 leading-relaxed font-light max-w-2xl mx-auto">
              Plan een gratis consult en ontdek welke processen jij slim kunt automatiseren met een autonome assistent.
            </p>
