...
const AgentPrimaryHero = () => {
  return <section className="relative min-h-[90vh] lg:min-h-[100vh] flex items-center overflow-hidden">
      ...
      {/* Ambient lighting effects with teal/green colors */}
      ...
      {/* Animated particles with teal/green colors - with fade overlay */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-8 order-2 lg:order-1">
            <div className="space-y-4 md:space-y-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
                Laat je AI zelfstandig werken
              </h1>
              
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-premium-silver/90 leading-relaxed">
                Slimme agents die taken begrijpen, uitvoeren en optimaliseren.
              </h2>
            </div>

            <p className="text-base sm:text-lg md:text-xl text-premium-silver/80 leading-relaxed max-w-2xl">
              Bouw autonome AI-agenten die complexe workflows zelfstandig uitvoeren. Ze analyseren data, nemen beslissingen en voeren acties uit — zonder menselijke tussenkomst.
            </p>

            <div className="pt-2 md:pt-4">
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-600 hover:to-emerald-700 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105" onClick={() => {
          ...
          <div className="relative flex items-center justify-center order-1 lg:order-2 py-8 md:py-12 lg:py-0">
            ...
            <div className="relative">
              ...
              background: 'radial-gradient(circle, rgba(20, 184, 166, 0.1) 0%, rgba(16, 185, 129, 0.05) 50%, transparent 70%)',
              animationDuration: '4s'
            }} />
              ...
              background: 'radial-gradient(circle, rgba(16, 185, 129, 0.15) 0%, rgba(20, 184, 166, 0.08) 50%, transparent 70%)',
              animationDuration: '3s',
              animationDelay: '-1s'
            }} />
              ...
              background: 'radial-gradient(circle, rgba(20, 184, 166, 0.2) 0%, rgba(16, 185, 129, 0.1) 40%, rgba(59, 130, 246, 0.05) 70%, transparent 100%)',
              ...
              {/* Orbiting agent network elements - responsive */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                ...
                background: i % 2 === 0 ? 'rgba(20, 184, 166, 0.8)' : 'rgba(16, 185, 129, 0.8)',
                animationDuration: `${8 + i * 2}s`,
                transform: `rotate(${i * 60}deg) translateY(-${90 + i * 15}px)`,
                transformOrigin: '50% 50%',
                boxShadow: `0 0 10px ${i % 2 === 0 ? 'rgba(20, 184, 166, 0.8)' : 'rgba(16, 185, 129, 0.8)'}`
              }} />)}
              </div>
            </div>

            {/* Agent network connections - responsive */}
            <div className="absolute inset-0 pointer-events-none">
              {/* AI agent flow lines - responsive sizing and positioning */}
              <div className="absolute top-1/4 left-1/4 w-24 md:w-32 h-0.5 bg-gradient-to-r from-teal-400/40 to-transparent transform rotate-45 animate-pulse" />
              <div className="absolute top-3/4 right-1/4 w-18 md:w-24 h-0.5 bg-gradient-to-l from-emerald-400/40 to-transparent transform -rotate-45 animate-pulse" style={{
              animationDelay: '1s'
            }} />
              <div className="absolute bottom-1/3 left-1/3 w-20 md:w-28 h-0.5 bg-gradient-to-r from-blue-400/40 to-transparent transform rotate-12 animate-pulse" style={{
              animationDelay: '2s'
            }} />
            </div>
          </div>
