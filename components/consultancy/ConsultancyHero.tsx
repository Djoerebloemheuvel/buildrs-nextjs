        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-8 order-2 lg:order-1">
            <div className="space-y-4 md:space-y-6">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-premium-silver/90 leading-relaxed">
                AI-consultancy die écht werkt. Strategisch, praktisch, meetbaar.
              </h2>
            </div>

            <p className="text-base sm:text-lg md:text-xl text-premium-silver/80 leading-relaxed max-w-2xl">
              Van analyse tot implementatie — wij begeleiden je stap voor stap naar AI-transformatie. Strategisch denken, praktische uitvoering, tastbare resultaten.
            </p>

            <div className="pt-2 md:pt-4">
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105" onClick={() => {
          ...
          <div className="relative flex items-center justify-center order-1 lg:order-2 py-8 md:py-12 lg:py-0">
            ...
            <div className="relative">
              ...
              background: 'radial-gradient(circle, rgba(59, 130, 246, 0.2) 0%, rgba(6, 182, 212, 0.1) 40%, rgba(14, 165, 233, 0.05) 70%, transparent 100%)',
              ...
              boxShadow: `
                ...
                <Brain className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 text-blue-300 drop-shadow-2xl animate-pulse" style={{
                filter: 'drop-shadow(0 0 20px rgba(59, 130, 246, 0.6))',
                animationDuration: '6s'
              }} />
              </div>
              
              {/* Orbiting consultancy network elements - responsive */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                ...
                background: i % 2 === 0 ? 'rgba(59, 130, 246, 0.8)' : 'rgba(6, 182, 212, 0.8)',
                animationDuration: `${8 + i * 2}s`,
                transform: `rotate(${i * 60}deg) translateY(-${90 + i * 15}px)`,
                transformOrigin: '50% 50%',
                boxShadow: `0 0 10px ${i % 2 === 0 ? 'rgba(59, 130, 246, 0.8)' : 'rgba(6, 182, 212, 0.8)'}`
              }} />)}
              </div>
            </div>

            {/* Consultancy network connections - responsive */}
            <div className="absolute inset-0 pointer-events-none">
              {/* AI consultancy flow lines - responsive sizing and positioning */}
              ...
              <div className="absolute top-3/4 right-1/4 w-18 md:w-24 h-0.5 bg-gradient-to-l from-sky-400/40 to-transparent transform -rotate-45 animate-pulse" style={{
              animationDelay: '1s'
            }} />
